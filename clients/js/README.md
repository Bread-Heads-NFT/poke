# JavaScript client for Bgh Poke
...
2. Next, install this library using the package manager of your choice.
   ```sh
   npm install @metaplex-foundation/bgh-poke
   ```
2. Finally, register the library with your Umi instance like so.
   ```ts
   import { bghPoke } from '@metaplex-foundation/bgh-poke';
   umi.use(bghPoke());
   ```

You can learn more about this library's API by reading its generated [TypeDoc documentation](https://bgh-poke-js-docs.vercel.app).
